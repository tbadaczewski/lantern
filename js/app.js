    ...
    function ($q) {
        return function () {
            ...
            function onError(error) {
                navigator.alert('code: '    + error.code    + '\n' + 'message: ' + error.message + '\n');//.notification.alert('There was a problem locating your position, please manually enter your city, state or zipcode.', null, 'Failed to Locate Position', 'Close');            
                deferred.resolve(null);
            }
