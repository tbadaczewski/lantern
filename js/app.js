        ...
        return function () {
            ...
            $http.get('https://baddie.parseapp.com/timeline').success(function (reply) {
                ...
                for(var i = 0; i < reply.length; i++) {
                    ...
                    formatted += "<div class='entry clearfix'><div class='message'><a href='' onclick='window.open(\"https://twitter.com/energy/status/" + id + "\",\"_system\");return false;' class='time'>" + parseTwitterDate(created_at) + "</a>";
                    
                    if(reply[i].retweeted_status) {
                        formatted += "<a href='' onclick='window.open(\"https://twitter.com/" + screen_name + "\",\"_system\");return false;' class='retweeted small'><span class='icon-retweet' aria-hidden='true'></span>" + name + " retweeted</a>";
                    }

                    formatted += "<a href='' onclick='window.open(\"https://twitter.com/" + screen_name + "\",\"_system\");return false;' class='logo'><img src='" + profile_image_url + "' /></a><a href='' ng-click='openwindow($event, https://twitter.com/" + screen_name + ")' class='title'>" + name + " <span class='nickname'>@" + screen_name + "</span></a><br />" + autoHyperlinkUrls(text) + "</div><div class='block'><div class='right'><a href='' ng-click='openwindow($event, https://twitter.com/intent/tweet?in_reply_to=" + id + ")'><span class='icon-reply size-22' aria-hidden='true'></span></a>&nbsp;&nbsp;&nbsp;<a href='' ng-click='openwindow($event, \"https://twitter.com/intent/retweet?tweet_id=" + id + "\")'><span class='icon-retweet size-22' aria-hidden='true'></span></a>&nbsp;&nbsp;&nbsp;<a href='' ng-click='openwindow($event, \"https://twitter.com/intent/favorite?tweet_id=" + id + "\")'><span class='icon-favorite size-22' aria-hidden='true'></span></a></div></div></div>";
                }
