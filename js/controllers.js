    ...
    function ($scope, $rootScope, $http, $window, geolocation, geoencoder) {
    	...
    	$scope.camera = function($event) {
			...
			navigator.notification.confirm(
			    '<h3>Terms & Conditions for Reporting Downed Power Lines</h3><ol><li>You must be 18 years of age or older to submit a photograph and/or text description.</li><li>This is not a replacement for 911 or calling local fire/EMS/police. If you are in need of emergency assistance, please contact 9-1-1.</li><li>Do not put yourself or any other person or property at risk to use this feature.</li><li>Do not use this feature to report criminal activity.</li><li>By submitting a photograph, you acknowledge that you own the copyright to the photograph and any associated text description and grant DOE a non-exclusive, royaltyfree, unconditional, world-wide license to use, display, and redistribute a copy of the photograph and any text description in any format to any entity.</li><li>DOE reserves the right to modify this policy at any time.</li></ol><h3>Content Guidelines</h3><ol><ol><li>Only images of damaged electric poles and power lines in the United States will be accepted.</li><li>All photographs must be geo-tagged.</li><li>All content is moderated.</li></ol><h3>Content (Photographs &amp;Text Descriptions) That Will Not Be Accepted</h3><ol><ol><li>Content that is not disaster-related and/or off-topic.</li><li>Content that includes abusive or vulgar language, hate speech, personal attacks, or similar content.</li><li>Content that includes personal information such as: social security number, identifiable addresses, and automobile license plates.</li><li>Content that promotes any commercial entities or products, or contains information on fundraising campaigns or partisan political activity.</li><li>Content that violates any person’s reasonable expectation of privacy or other privacy interest, including, but not limited to, people on private property, children, interiors of homes, deceased or injured persons, and interiors of hospitals or other medical facilities.</li></ol>',
			     onConfirm,
			    'Disclaimer',
			    ['Cancel','Ok']
			);
